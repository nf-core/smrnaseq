...
#
# This script performs the identification of miRNAs targets from the DGE analysis on miRNA data.
# It requires the DGE_miRNAs.RData file and the organism name as input.
# It generates a summary of miRNA targets and saves the results in an Excel file.
# -------------------------------
