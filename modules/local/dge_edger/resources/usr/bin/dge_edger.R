...
# DGE edgeR script for miRNAs
# Author: Karla Ruiz - IU2 OMICS HT 
# Date: 2024-12-13
...
perform_dge_analysis <- function(rawCountTable, metadata) {
  ...
  ## Volcanoplot
      ...
      #png
      png(file.path(dge_png_plots_folder, paste0("heatmap_", contrast_name, ".png")), height = 7, width = 7, res = 600, units = "in")
      par(mfrow=c(4, 4))
      ...
      #pdf
      pdf(file.path(dge_pdf_plots_folder, paste0("heatmap_", contrast_name, ".pdf")), height = 7, width = 7)
      par(mfrow=c(4, 4))
      heatmap.2(highly_variable_mir_lcpm,
                col=rev(morecols(50)),
                trace="none", 
