...
def helpMessage() {
    ...
    Mandatory arguments:
      ...
      --genome                      Name of iGenomes reference. Not needed if --mature, --hairpin, --mirtrace_species and --refgenome are provided.
    ...
    Other options
      ...
      --skip_mirdeep                If this parameter is specified, it stops the detection of novel miRNAs with miRDeep2. Default: false
      --miRNAs_PDF                  If this parameter is specified, it outputs the PDFs of the miRNAs (it occupies a lot of space). Default: false
    AWSBatch options:
...
process make_bowtie_index {
    ...
    output:
    file 'mature_idx.*' into mature_index_bowtie, mature_index_mirdeep2
    file 'hairpin_idx.*' into hairpin_index_bowtie, hairpin_index_mirdeep2
...
if (! params.skip_mirdeep){
    ...
    process mapper_mirdeep2 {
      ...
      -t ${reads.baseName}reads_vs_refdb.arf \\
      -o 4
      """
    }
    ...
    process mirdeep2 {
      ...
      if (params.miRNAs_PDF) {file 'pdfs*'}
